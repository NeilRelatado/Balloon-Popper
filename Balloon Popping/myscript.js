...
balloonVariable.addEventListener("mouseover",popballon);
function popballon(){
...
balloonVariable.addEventListener("mouseout",popIsOver,false);
    ...
    function noBalloons(){
        if(balloon0.style.background ==="none" && 
        ...
        balloon11.style.background ==="none" &&
        balloon12.style.background ==="none" &&
        balloon13.style.background ==="none" &&
        balloon14.style.background ==="none" &&
        balloon15.style.background ==="none" &&
        balloon16.style.background ==="none" &&
        balloon17.style.background ==="none" &&
        balloon18.style.background ==="none" &&
        balloon19.style.background ==="none" &&
        balloon20.style.background ==="none" &&
        balloon21.style.background ==="none" &&
        balloon22.style.background ==="none" &&
        balloon23.style.background ==="none" )
        {
